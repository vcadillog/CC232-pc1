...
7. El método get(i) recorre la lista desde el inicio o el final dependiendo de si i es menor o mayor a n/2, por lo que el costo es O(1 + min(i, n-i)) porque se recorre como máximo la mitad de la lista.
